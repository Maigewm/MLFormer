...
class KGProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        ...
        return self._create_examples(
            ...
            #self._read_tsv(os.path.join(data_dir, "train_reverse.tsv")), "train", data_dir, self.args)
    def get_dev_examples(self, data_dir):
        """See base class."""
        return self._create_examples(
    ...
    def get_relations(self, data_dir):
        ...
        #with open(os.path.join(data_dir, "relations_reverse.txt"), 'r') as f:
            lines = f.readlines()
            relations = []
            for line in lines:
    ...
    def get_labels(self, data_dir):
        ...
        #with open(os.path.join(data_dir, "relation2text_reverse.txt"), 'r') as f:
            lines = f.readlines()
            entities = []
            for line in lines:
    ...
    def get_train_triples(self, data_dir):
        ...
        #return self._read_tsv(os.path.join(data_dir, "train_reverse.tsv"))
    ...
    def _create_examples(self, lines, set_type, data_dir, args):
        ...
        #with open(os.path.join(data_dir, "relations_reverse.txt"), "r") as file:
            i=0
        ...
        #dataset_list = ["train_reverse.tsv", "dev.tsv", "test.tsv"]
